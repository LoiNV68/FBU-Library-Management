...
const chartBooks = new Chart(ctxBooks, {
    type: "bar",
    data: {
        labels: ["Tổng số sách", "Sách sẵn sàng cho mượn", "Sách đang mượn", "Sách bị mất, hỏng"],
        datasets: [{
            label: "Số lượng",
            data: [1234, 567, 567, 89],
            backgroundColor: [
                "rgba(50, 148, 201, 0.2)",
                "rgba(75, 192, 192, 0.2)",
                "rgba(255, 159, 64, 0.2)",
...
const chartReaders = new Chart(ctxReaders, {
    type: "bar",
    data: {
        labels: ["Tổng số bạn đọc", "Bạn đọc đang mượn", "Bạn đọc mới (tháng)", "Bạn đọc vi phạm"],
        datasets: [{
            label: "Số lượng",
            data: [456, 123, 23, 12],
            backgroundColor: [
